...
fn int16() {
  let output = RemotingMessage {
    ...
    objects: BTreeMap::from_iter([(
      Int32(1),
      Object::Object {
        class: ObjectClass { name: "System.SByte", library: None },
        members: BTreeMap::from_iter([("m_value", Object::Primitive(MemberPrimitiveUnTyped::SByte(Int8(-127))))]),
      },
    )]),
